...
class WatchMovieRepository(private val api: Api) : IWatchMovieRepository {

    override suspend fun search(query: String): ApiResult<String?> {
        return try {
    ...
    override suspend fun getMovieDetails(path: String): ApiResult<ExMovie> {
        return try {
    ...
    override suspend fun loadMovieResolutions(
        movieID: Int,
        translationId: Int,
        season: Int?,
        episode: Int?
    ...
    override suspend fun loadSeasonsForTranslation(
        movieID: Int,
        translationId: Int
    ...
    override suspend fun getMovieTrailer(movieID: Int): ApiResult<String> {
        return try {
